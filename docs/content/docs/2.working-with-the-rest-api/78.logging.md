...
| --- | --- | --- | --- |
| `post/send` (request being dispatched) | logger context `params` | `info` | [`abstract-http.ts:544`](https://github.com/bitrix24/b24jssdk/blob/main/packages/jssdk/src/core/http/abstract-http.ts#L544) |
| `post/response` (success body) | logger context `result` | `info` | [`abstract-http.ts:561`](https://github.com/bitrix24/b24jssdk/blob/main/packages/jssdk/src/core/http/abstract-http.ts#L561) |
| `post/catchError` (axios error) | logger context `responseData` | `info` | [`abstract-http.ts:506`](https://github.com/bitrix24/b24jssdk/blob/main/packages/jssdk/src/core/http/abstract-http.ts#L506) |
