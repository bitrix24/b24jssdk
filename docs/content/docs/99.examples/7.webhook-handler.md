...
- Event registration is a one-off setup: `crm.event.bind` (or via portal admin → Settings → Webhooks). Not done by this recipe.
- Verify the request origin in production — Bitrix24 includes auth fields you can match against your portal id.
