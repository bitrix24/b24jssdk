---
title: UMD
description: 'Complete guide for using UMD version Bitrix24 JS SDK in you applications.'
---
...
After including the library, it will be available through the global variable `B24Js`.
...
<script>
  // Create logger
  const logger = B24Js.LoggerBrowser.build('B24/jsSdk::umd', true);
