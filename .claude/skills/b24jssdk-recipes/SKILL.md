...
For the v3 wire-level details (filter grammar, aggregate functions, batch `$ref`/`$refArray`, cursor pagination) see `.claude/bitrix24-rest-v3-reference.md` — it's grounded in the server PHP source.
