...
links:
  - label: Source on GitHub
    iconName: GitHubIcon
    to: https://github.com/bitrix24/b24jssdk/blob/main/.claude/skills/b24jssdk-recipes/examples/03-task-automation.ts
---
...
[`.claude/skills/b24jssdk-recipes/examples/03-task-automation.ts`](https://github.com/bitrix24/b24jssdk/blob/main/.claude/skills/b24jssdk-recipes/examples/03-task-automation.ts).
