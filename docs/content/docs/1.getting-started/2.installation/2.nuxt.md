...
You need to use the `B24Frame` object. It is initialized on the client side using `initializeB24Frame()`.
...
const $logger = LoggerFactory.createForBrowser('B24/jsSdk::nuxt', devMode)
