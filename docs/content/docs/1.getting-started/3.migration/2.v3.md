...
JavaScript's order provably matches the server's: both of equal length, and only as
digits (a zero-padded id) or as ISO-8601 datetimes that state the **same** zone
...
`2024-10-27 02:15:00`{lang="ts-type"}, where the repeated wall-clock hour makes
