...
export abstract class AbstractB24 implements TypeB24 {
   ...
   *
   * @deprecated This const is deprecated and will be removed in version `2.1.0`
   * @removed 2.1.0
   */
  ...
  public async callMethod(method: string, params?: object, start?: number): Promise<AjaxResult> {
    LoggerFactory.forcedLog(
      this._logger,
      'warning',
      `The AbstractB24.callMethod() method is deprecated and will be removed in version 2.1.0. Use b24.actions.v3.call.make(options) or b24.actions.v2.call.make(options)`,
      {
        class: 'AbstractB24',
        method: 'callMethod',
  ...
  public async callListMethod(method: string, params?: object, progress?: null | ((progress: number) => void), customKeyForResult?: string | null): Promise<Result> {
    LoggerFactory.forcedLog(
      this._logger,
      'warning',
      `The AbstractB24.callListMethod() method is deprecated and will be removed in version 2.1.0. Use b24.actions.v3.callList.make(options) or b24.actions.v2.callList.make(options)`,
      {
        class: 'AbstractB24',
  ...
  public async* fetchListMethod(method: string, params?: any, idKey?: string, customKeyForResult?: string | null): AsyncGenerator<any[]> {
    LoggerFactory.forcedLog(
      this._logger,
      'warning',
      `The AbstractB24.fetchListMethod() method is deprecated and will be removed in version 2.1.0. Use b24.actions.v3.fetchList.make(options) or b24.actions.v2.fetchList.make(options)`,
      {
        class: 'AbstractB24',
  ...
  public async callBatch(calls: Array<any> | object, isHaltOnError?: boolean, returnAjaxResult?: boolean): Promise<Result> {
    LoggerFactory.forcedLog(
      this._logger,
      'warning',
      `The AbstractB24.callBatch() method is deprecated and will be removed in version 2.1.0. Use b24.actions.v3.batch.make(options) or b24.actions.v2.batch.make(options)`,
      {
        class: 'AbstractB24',
        method: 'callBatch',
  ...
  public async callBatchByChunk(calls: Array<any>, isHaltOnError: boolean): Promise<Result> {
    LoggerFactory.forcedLog(
      this._logger,
      'warning',
      `The AbstractB24.callBatchByChunk() method is deprecated and will be removed in version 2.1.0. Use b24.actions.v3.batchByChunk.make(options) or b24.actions.v2.batchByChunk.make(options)`,
      {
        class: 'AbstractB24',
