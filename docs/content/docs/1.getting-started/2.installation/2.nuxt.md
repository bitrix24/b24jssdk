...
links:
  - label: Nuxt module
    iconName: GitHubIcon
    to: https://github.com/bitrix24/b24jssdk/blob/main/packages/jssdk-nuxt/src/module.ts
  - label: Runtime plugin
    iconName: GitHubIcon
    to: https://github.com/bitrix24/b24jssdk/blob/main/packages/jssdk-nuxt/src/runtime/plugin.ts
---
