...
anyone: no shipped Bitrix24 module publishes an `*.aggregate` action, so there is
nothing on a real portal to call it on yet. It is listed here for the callers who
