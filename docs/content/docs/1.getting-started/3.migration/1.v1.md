...
Now forced display is used via [`LoggerFactory.forcedLog()`{lang="ts-type"}](/docs/logger/)

### Restriction Manager

The `RestrictionManager` class has been removed. The [`Limiters`](/docs/limiters/) system is used instead.
