...
- Where a method has a v3 form, prefer the explicit `actions.v3.*` surface — see [available v3 methods](https://apidocs.bitrix24.com/api-reference/rest-v3/index.html).
::
