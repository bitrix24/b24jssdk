 ...
 *
 * NOTE: getNext() is @deprecated and removed in v3.0.0. isMore() is NOT — it is a
 * restApi:v2 envelope reader that stays, and answers false under restApi:v3.
...
export async function pagingV2Example(b24: TypeB24) {
  ...
  // getNext() is @deprecated — removed in v3.0.0. Shown here for guide coverage only.
  // isMore() stays, but only ever reports something under restApi:v2.
  if (result.isMore()) {
