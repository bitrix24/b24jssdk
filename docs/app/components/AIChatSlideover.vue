...
const faqQuestions = [
  {
    ...
    items: [
      'How to use the Js SDK in a Nuxt project?',
      'How to use the Js SDK in a Vue project?',
      'How to use the Js SDK in a React project?',
      'How to use the Js SDK in a native JavaScript (UMD) project?',
      'How to use the Js SDK in a NodeJs project?'
    ]
  },
  {
    category: 'Frame',
    items: [
      'How to connect and use Frame?'
    ]
  },
  {
    category: 'Hook',
    items: [
      'How to connect and use Hook?'
    ]
  },
  {
    category: 'OAuth',
    items: [
      'How to create a setup wizard page?',
      'How to get and display a list of companies with pagination?'
    ]
  },
  {
    category: 'Example',
    items: [
      'Как сделать страницу с мастером установки?',
      'Как получить и показать список компаний с учетом постраничной навигации?'
    ]
  }
]
