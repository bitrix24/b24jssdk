...
::note
Using a custom logger via `setLogger(...)`? See [Logging & Credential Redaction](/docs/working-with-the-rest-api/logging/) for what the SDK protects automatically and what you still need to control on your side.
::
