 ...
 *
 * NOTE: isMore() and getNext() are @deprecated and will be removed in v3.0.0.
...
export async function pagingV2Example(b24: TypeB24) {
  ...
  // isMore() and getNext() are @deprecated — removed in v3.0.0. Shown here for guide coverage only.
  if (result.isMore()) {
