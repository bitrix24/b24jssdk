...
<template>
	<h2 class="text-h2">Hook</h2>
	<ul class="list-disc list-inside">
		<li class="py-2"><NuxtLink class="hover:text-info" to="/hook/crm.item.list">List Company</NuxtLink></li>
	...
	<ul class="list-disc list-inside">
		<li class="py-2"><NuxtLink class="hover:text-info" to="/frame/testing-rest-api-calls">Testing Rest-Api Calls</NuxtLink></li>
	</ul>
