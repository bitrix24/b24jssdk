...
```
The parameters this frame was opened with, always as a frozen object — including
...
::note
**Three shapes arrive on the wire, and all three are normalised before they get
here.** The portal sends an object, a **JSON string** (on the form-resubmit path),
or an **empty string** when the placement was opened with no parameters at all.
