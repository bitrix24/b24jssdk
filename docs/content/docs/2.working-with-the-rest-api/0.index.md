---
title: B24Hook
description: 'Class for secure interaction with the Bitrix24 REST API from server-side code. Contains methods for creating authorized requests via webhooks. Works only in server environment.'
navigation:
  title: B24Hook
links:
  - label: B24Hook
