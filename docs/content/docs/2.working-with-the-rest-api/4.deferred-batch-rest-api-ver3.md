...
be read: the portal serves it with `Access-Control-Allow-Origin: *` (measured,
[#573](https://github.com/bitrix24/b24jssdk/issues/573)); a full run from a frame
has not been done. `idempotencyKey` is not available in a browser — see
[Idempotency-Key](/docs/working-with-the-rest-api/call-rest-api-ver3/#idempotency-key).
::
